...
|---|---|
| **Type** | Kingdom |
| **Capital** | [Morgan's Keep](/places/morgans-keep) |
| **Government** | Monarchy |
| **Status** | In turmoil |

</WikiInfobox>

**The Kingdom of Morgan** is the realm in which the campaign takes place. It is a human-dominated kingdom with significant non-human populations, currently in political upheaval following the [murder of the Crown Prince](/events/crown-prince-murder).

## Geography

The kingdom spans from coastal port cities to mountain strongholds:

- **[Morgan's Keep](/places/morgans-keep)** — The capital, centrally located
- **[Rinden](/places/rinden)** — A major port city with the [Saltside](/places/saltside) wealthy district
- **[Turn](/places/turn)** — An inland trading town
- **[Greenfield](/places/greenfield)** — A small rural town between the capital and Turn
- **[Dior](/places/dior)** — A mountain city built in a crater-like valley
- **[Hooves Bay](/places/hooves-bay)** — A coastal settlement
- **[Sire](/places/sire)** — A river town (now burned)
- **[Kalén](/places/kalen)** — A settlement along the river

## Politics

The kingdom is experiencing internal strife:
