...
| | |
|---|---|
| **Type** | Fey realm (elvish name) |
| **Known for** | Metalwork, optical lenses |
| **First Seen** | [Session 16](/sessions/session-16) (mentioned) |

</WikiInfobox>

**Alverike** is the elvish name for the [Fey Realm](/places/fey-realm) — also used for elven crafts exported into the [Kingdom of Morgan](/places/kingdom-of-morgan). The realm is renowned for metalwork and rare craftsmanship, including optical **glasses** that are virtually unknown elsewhere in the kingdom.
