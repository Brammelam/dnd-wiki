          ...
          items: [
            {
              ...
              collapsed: false,
              items: [
                { text: 'Varis', link: '/characters/varis' },
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Magda', link: '/characters/magda' },
                { text: 'Gregory Alabaster (IV)', link: '/characters/gregory-alabaster' },
                { text: 'Jamaris Jamarisen Llamar', link: '/characters/jamaris-jamarisen-llamar' },
                { text: 'Rudolf the Great', link: '/characters/rudolf-the-great' },
                { text: 'Maurus', link: '/characters/maurus' },
                { text: 'Viktor Carnelian', link: '/characters/viktor-carnelian' },
              ],
            },
          ],
        },
      ...
      '/places/': [
        {
          ...
          items: [
            ...
            { text: 'Common District', link: '/places/common-district' },
      ...
      '/events/': [
        {
          ...
          items: [
            ...
            { text: 'Alabaster Crypt Infiltration', link: '/events/alabaster-crypt-infiltration' },
            { text: 'Capital Cathedral Undead Riot', link: '/events/capital-cathedral-undead-riot' },
            { text: 'Fall of Lady Alabaster', link: '/events/fall-of-lady-alabaster' },
          ],
        },
      ],
      ...
      '/sessions/': [
        {
          ...
          items: [
            ...
            { text: 'Session 25 – Crypt of Morgan (Alabaster)', link: '/sessions/session-25' },
            { text: 'Session 26 – Escaping the Cathedral', link: '/sessions/session-26' },
            { text: 'Session 27 – Infiltrating Humanus', link: '/sessions/session-27' },
            { text: 'Session 28 – The Burning Barge', link: '/sessions/session-28' },
            { text: 'Session 29 – Trial of Lady Alabaster', link: '/sessions/session-29' },
          ],
        },
      ],
    },
